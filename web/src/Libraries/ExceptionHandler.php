...
class ExceptionHandler
{
  ...
  ): bool
  {
    ...
    if ($context->stacktrace[0]['function'] == 'errorHandler'
      ...
      && $context->stacktrace[0]['class'] == 'PvPGNTracker\\Libraries\\ExceptionHandler')
    {
  ...
  private static function gracefulExit(StdClass &$context): void
  {
    ...
    {
      (new \PvPGNTracker\Libraries\Template(null, 'ExceptionHandler'))->invoke();
    }
    else
    {
  ...
  public static function register(): void
  {
    self::$overridden_error_handler = \set_error_handler(
      '\\PvPGNTracker\\Libraries\\ExceptionHandler::errorHandler'
    );
    self::$overridden_exception_handler = \set_exception_handler(
      '\\PvPGNTracker\\Libraries\\ExceptionHandler::exceptionHandler'
    );
  }
}
