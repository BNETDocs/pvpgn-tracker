...
final class Router
{
  ...
  public static string $controller_namespace = '\\PvPGNTracker\\Controllers\\';
  public static string $global_namespace = '\\PvPGNTracker\\';
  public static string $view_namespace = '\\PvPGNTracker\\Views\\';
  ...
  protected static function invokeController(\PvPGNTracker\Interfaces\Controller $controller, string $view, ?array $args): void
  {
  ...
  protected static function negotiateView(array $route_views): string
  {
    ...
    foreach ($route_views as $view_class)
    {
      ...
      if (!\class_exists($view_class)) throw new \PvPGNTracker\Exceptions\InvalidViewException($view_class);
